...
public class ExceptionInfoHandler {
    ...
    public ErrorInfo handleMethodArgumentNotValidException(HttpServletRequest req, MethodArgumentNotValidException error) {
        return logAndGetErrorInfo(req, error, true, DATA_ERROR);
    }
    ...
    private static ErrorInfo logAndGetErrorInfo(HttpServletRequest req, Exception e, boolean logException, ErrorType errorType) {
        ...
        return new ErrorInfo(req.getRequestURL(), errorType.getTitle(), rootCause.getMessage());
    }
    ...
    private static ErrorInfo logAndGetErrorInfo(HttpServletRequest req, Exception e, boolean logException, ErrorType errorType, String details) {
        ...
        return new ErrorInfo(req.getRequestURL(), errorType.getTitle(), details);
    }
}